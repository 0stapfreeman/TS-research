...
import numpy as np
from src.approximation import large_coefficient_approx
...
def run_experiment(
    ...
    from src.signal_utils import sample_signal, plot_reconstruction
...
def recover_polynomial_approx(
    ...
    **Polynomial Approximation (Adaptive L2 fitting)**:
    ...
    """
    from src.fourier_core import DFT_unitary
    from src.approximation import large_coefficient_approx_adaptive
